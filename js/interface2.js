// thiết lập số chạy ở bảng kỹ năng phần mềm
...
// thiết lập số lượng khách hàng chạy ở bảng client
...
$(".clients-carousel-2").owlCarousel({
  ...
  // Hàm kiểm tra xem phần tử có id="masthead" có xuất hiện trên màn hình hay không
  function isElementInViewport(el) {
  ...
  // Hàm cuộn trang web xuống 700px
  function scrollTo700px() {
    window.scrollTo({
      top: 635,
      behavior: 'smooth'
    });
  ...
  // Sử dụng Intersection Observer để theo dõi sự xuất hiện của phần tử có id="masthead"
  var masthead = document.getElementById('masthead');
  var observer = new IntersectionObserver(function(entries) {
    // Nếu phần tử xuất hiện trên màn hình
    if (entries[0].isIntersecting) {
      // Đợi 13 giây sau đó cuộn trang web xuống 700px
      setTimeout(scrollTo700px, 13000);
      // Ngừng theo dõi phần tử
      observer.disconnect();
    }
  });

  // Bắt đầu theo dõi phần tử có id="masthead"
